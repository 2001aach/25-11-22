...
from homeapp.models import userpage,workerpage
...
def user_button(request):
    return render(request,"user_button.html")
...
def worker_button(request):
    return render(request,"worker_button.html")
